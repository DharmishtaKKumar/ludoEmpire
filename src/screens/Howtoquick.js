...
export default function Howtoquick ({navigation}) {
        ...
        return(
          <Background>
                ...
                <ImageBackground
                    ...
                    <Text style={{fontWeight:'400', fontSize:12, color:"#DF9D21", textAlign:'center'}}>Win by taking all 2 gotis home</Text>
                    ...
                    <Image 
                        ...
                        <View style={{flexDirection:'column', marginLeft:'5%', marginRight:'5%'}}>
                            ...
                            <Text style={{fontWeight:'700', fontSize:10,color:'#fff', marginTop:'5%'}}> In our Quick Ludo, the 4 pawns start together from the colored box outside the base.</Text>
                            </View>
                            
                            <View style={{flexDirection:'row'}}>
                            <Text style={{fontWeight:'700', fontSize:10,color:'#fff', marginTop:'5%'}}>2. </Text>
                            <Text style={{fontWeight:'700', fontSize:10,color:'#fff', marginTop:'5%'}}> In Quick Ludo, you can start moving pawns immediately</Text>
                            </View>
          
                            <View style={{flexDirection:'row'}}>
                            <Text style={{fontWeight:'700', fontSize:10,color:'#fff', marginTop:'5%'}}>3. </Text>
                            <Text style={{fontWeight:'700', fontSize:10,color:'#fff', marginTop:'5%'}}>Win a match by taking just 2 pawns home before your opponents.</Text>
                            </View>
