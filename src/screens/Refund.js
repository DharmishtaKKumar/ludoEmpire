         ...
         <TouchableOpacity>
                ...
                <ImageBackground
                    ...
                    source={require("../../assets/Main/yellowheading.png")}>
                        <Text style={{fontWeight:'700',fontSize:16, color:"#fff",marginLeft:"3%",marginTop:'2%', marginRight:"4%"}}>REFUND & CANCELLATIONS</Text>
                    </ImageBackground>
                     </ImageBackground>
...
Ludo Empire shall be entitled to modify these Terms and 
...
down, the additional conditions shall prevail.</Text>
                  ...
                  <Text style={style.content}>Ludo Empire may, at its sole and absolute discretion: </Text>
                  
                  <Text style={style.bulletpoint}>{'\u2B24'}Restrict, suspend, or terminate any User's access to all or </Text>
                  <Text style={style.bulletpoint}>{'\u2B24'}any part of Ludo Empire or Ludo Empire Services </Text>
                  <Text style={style.bulletpoint}>{'\u2B24'} Change, suspend, or discontinue all or any part of the </Text>
                  <Text style={style.bulletpoint}>{'\u2B24'}Ludo Empire Services </Text>
                  <Text style={style.bulletpoint}>{'\u2B24'} Reject, move, or remove any material that may be submitted by a User;</Text>
                  <Text style={style.bulletpoint}>{'\u2B24'} Move or remove any content that is available on Ludo Empire;</Text>
                  <Text style={style.bulletpoint}>{'\u2B24'}Deactivate or delete a user's account and all related information and files on the account; </Text>
                  <Text style={style.bulletpoint}>{'\u2B24'}Establish general practices and limits concerning use of Ludo Empire; </Text>
...
these Terms and Conditions; or</Text>

                  <Text style={style.content}>
Any circumstances beyond the reasonable control of Ludo 
Empire.</Text>

                  <Text style={style.content}>Users consent to receiving communications such as 
announcements, administrative messages and 
advertisements from Ludo Empire or any of its partners, 
licensors or associates.</Text>
 

                  <Text style={style.yellowheading}> How do I withdrawal cash</Text>

                  <Text style={style.contentwithoutspace}>You can withdraw your winning amount only from the win 
...
because we follow secure payment gateways.</Text>
...
or in part without express written license from Ludo Empire.</Text>

                  <Text style={style.content}>
Users may request permission to use any Ludo Empire 
content by writing in to Ludo Empire Help-desk.</Text>
...
Users' Content for any of the following purposes:</Text>

                  <Text style={style.content}>Displaying Users Content on Ludo Empire
...
of Users Content in any form, medium, or technology.
                  ...
                  <Text style={style.content}>All names, logos, marks, labels, trademarks, copyrights or 
...
respective parties under notice to Ludo Empire.</Text>

                  <Text style={style.content}>Third Party Sites, Services and Products</Text>

                  <Text style={style.contentwithoutspace}>Ludo Empire may contain links to other Internet sites owned 
...
Empire of such third-party Internet sites.</Text>

                  <Text style={style.content}>Users' correspondence, transactions or related activities 
...
service should be directed to the appropriate vendor.</Text>

                  <Text style={style.content}>Ludo Empire contains content that is created by Ludo Empire 
...
of the contests hosted on Ludo Empire.</Text>

                  <Text style={style.yellowheading}>Privacy Policy</Text>

                  <Text style={style.contentwithoutspace}>All information collected from Users, such as registration 
and credit card information, is subject to Ludo Empire's 
Privacy Policy which is available at Privacy Policy.</Text>

                  <Text style={style.yellowheading}>User Conduct</Text>

                  <Text style={style.contentwithoutspace}>Users agree to abide by these Terms and Conditions and all 
...
to all or any part of Ludo Empire Services;</Text>
...
User.</Text>
                  ...
                  <Text style={style.content}>Users agree to provide true, accurate, current and complete 
information at the time of registration and at all other times 
(as required by Ludo Empire). Users further agree to update 
and keep updated their registration information.</Text>

                  <Text style={style.content}>A User shall register or operate more than one User account 
with Ludo Empire.</Text>
...
or spam folder.</Text>
                  ...
                  <Text style={style.content}>Any password issued by Ludo Empire to a User may not be 
...
with these requirements.
                  ...
                  <Text style={style.content}>Users agree not to use cheats, exploits, automation, software, 
bots, hacks or any unauthorized third-party software 
designed to modify or interfere with Ludo Empire Services 
and/or Ludo Empire experience or assist in such activity.</Text>

                  <Text style={style.content}>Users agree not to copy, modify, rent, lease, loan, sell, assign, 
distribute, reverse engineer, grant a security interest in, or 
otherwise transfer any right to the technology or software 
underlying Ludo Empire or Ludo Empire Services.</Text>

                  <Text style={style.content}>Users agree that without Ludo Empire's express written 
...
Empire Services by any other User or person.</Text>
...
Ludo Empire Services.</Text>
                  ...
                  <Text style={style.content}>Users shall not attempt to gain unauthorized access to the 
...
software that underlies or is part of Ludo Empire Services.</Text>

                  <Text style={style.content}>
Without limiting the foregoing, Users agree not to use Ludo 
Empire for any of the following:</Text>

                  <Text style={style.content}>To engage in any obscene, offensive, indecent, racial, communal, anti-national, objectionable, defamatory or 
abusive action or communication;</Text>

                  <Text style={style.contentwithoutspace}>To harass, stalk, threaten, or otherwise violate any legal 
rights of other individuals;</Text>

                  <Text style={style.contentwithoutspace}>To publish, post, upload, e-mail, distribute, or disseminate 
(collectively, "Transmit") any inappropriate, profane, 
defamatory, infringing, obscene, indecent, or unlawful 
content;</Text>

                  <Text style={style.contentwithoutspace}>To Transmit files that contain viruses, corrupted files, or 
...
telecommunications equipment;</Text>

                  <Text style={style.contentwithoutspace}>To advertise, offer or sell any goods or services for any 
commercial purpose on Ludo Empire without the express 
written consent of Ludo Empire;</Text>

                  <Text style={style.contentwithoutspace}>To Transmit content regarding services, products, 
surveys, contests, pyramid schemes, spam, unsolicited 
advertising or promotional materials, or chain letters;</Text>

                  <Text style={style.contentwithoutspace}>To advertise, offer or sell any goods or services for any 
commercial purpose on Ludo Empire without the express 
written consent of Ludo Empire;</Text>

                  <Text style={style.contentwithoutspace}>To download any file, recompile or disassemble or 
otherwise affect our products that you know or 
reasonably should know cannot be legally obtained in 
such manner;</Text>

                  
                  <Text style={style.contentwithoutspace}>To falsify or delete any author attributions, legal or other 
proper notices or proprietary designations or labels of the 
origin or the source of software or other material;</Text>

                  
                  <Text style={style.contentwithoutspace}>To restrict or inhibit any other user from using and 
enjoying any public area within our sites;</Text>

                  
                  <Text style={style.contentwithoutspace}>To collect or store personal information about other Users;</Text>

                  
                  <Text style={style.contentwithoutspace}>To interfere with or disrupt Ludo Empire, servers, or 
networks;</Text>

                  
                  <Text style={style.contentwithoutspace}>To impersonate any person or entity, including, but not 
limited to, a representative of Ludo Empire, or falsely 
state or otherwise misrepresent User's affiliation with a 
person or entity;</Text>


                  
                  <Text style={style.contentwithoutspace}>To forge headers or manipulate identifiers or other data 
...
Ludo Empire(s);</Text>
                  ...
                  <Text style={style.contentwithoutspace}>To take any action that imposes an unreasonably or 
disproportionately large load on our infrastructure;</Text>


                  
                  <Text style={style.contentwithoutspace}>To engage in any illegal activities. You agree to use our 
...
related to that particular Forum.</Text>

                  
                  <Text style={style.contentwithoutspace}>If a User chooses a username that, in Ludo Empire's 
...
these options.</Text>
                  ...
                  <Text style={style.contentwithoutspace}>Unauthorized access to the Ludo Empire is a breach of these 
...
have approved in advance and in writing.</Text>
                  
                  <Text style={style.contentwithoutspace}>Use of Ludo Empire is subject to existing laws and legal 
...
relating to Users' use of Ludo Empire.</Text>

                  
                  <Text style={style.contentwithoutspace}>Users may contact Ludo Empire Help-desk with problems or 
questions, as appropriate.</Text>

                  <Text style={style.contentwithoutspace}>Persons below the age of eighteen (18) years are not 
...
knowledge of Ludo Empire.</Text>

                  <Text style={style.contentwithoutspace}>Ludo Empire believes that parents should supervise their 
...
information without parental permission.</Text>

                  <Text style={style.contentwithoutspace}>Although persons below the age of 18 years are allowed to 
use certain Ludo Empire Services on the Ludo Empire & it is 
limited to play only on practice mode.</Text>

                  <Text style={style.contentwithoutspace}>Ludo Empire may not be held responsible for any content 
contributed by Users on the Ludo Empire.</Text>

                  <Text style={style.contentwithoutspace}>Registration</Text>

                  <Text style={style.contentwithoutspace}>In order to register for the Contest(s), Participants may 
require to accurately provide the following information:</Text>

                  <Text style={style.bulletpoint}>{'\u2B24'} Name or User Name</Text>

                  <Text style={style.bulletpoint}>{'\u2B24'}E-mail address</Text>

                  <Text style={style.bulletpoint}>{'\u2B24'}Mobile Number</Text>

                  <Text style={style.bulletpoint}>{'\u2B24'}Password</Text>
              

                  <Text style={style.contentwithoutspace}>For getting any winning amount, participant may require to 
share his /her bank account details correctly
Ludo Empire is not liable for any transaction, if details 
provided by the user are incorrect.</Text>

                  <Text style={style.contentwithoutspace}>A participant will receive his/ her winnings in his bank 
...
read, and shall abide by, these Terms and Conditions.</Text>



                  <Text style={style.contentwithoutspace}>In the event a Participant indicates, while entering an 
...
below.</Text>
                  ...
                  <Text style={style.contentwithoutspace}>Contest(s), Participation and Prizes</Text>


                  <Text style={style.contentwithoutspace}>Ludo Empire offers a platform where one can purchase coins 
...
playing table.</Text>
                  ...
                  <Text style={style.contentwithoutspace}>Any player who loses the game, will get its coins deducted at 
...
platform fee.</Text>
                  ...
                  <Text style={style.contentwithoutspace}>A participant can redeem his/ her coins into the bank 
account or in Paytm wallet by submitting a redeem request 
& by providing correct bank or Paytm details.</Text>


                  <Text style={style.contentwithoutspace}>A participant can redeem coins from his / her Ludo Empire 
wallet if & only if participant's Ludo Empire Win wallet has a 
minimum of 50 coins.</Text>


                  <Text style={style.contentwithoutspace}>Ludo Empire shall not charge any processing fee for the 
...
provide correct bank details accordingly.</Text>

                  <Text style={style.contentwithoutspace}>Any player who exits the game in between or not play on his 
...
faced by user.</Text>
                  ...
                  <Text style={style.contentwithoutspace}>Ludo Empire will give users 120 seconds (2 minutes) of 
...
Legality of Game of Skill</Text>

                  <Text style={style.contentwithoutspace}>Games of skill are legal, as they are excluded from the ambit 
...
and K.R Lakshmanan. State of Tamil Nadu </Text>

                  <Text style={style.contentwithoutspace}>(AIR 1996 SC 1153) has held that a game in which success 
depends predominantly upon the superior knowledge, 
training, attention, experience and adroitness of the player 
shall be classified as a game of skill.</Text>


                  <Text style={style.contentwithoutspace}> The contest described above is prominently a game of skill, 
...
the safe points (stars) to let it unaffected by opponent's token</Text>
...
win a game.</Text>
                  ...
                  <Text style={style.contentwithoutspace}> A player with good experience & understanding of ludo skills 
with best of strategy building skills along with excellent 
presence of mind can dominate.</Text>

                  <Text style={style.contentwithoutspace}>Ludo Empire therefore offers a practice mode to let all 
...
of dice </Text>
                  ...
                  <Text style={style.contentwithoutspace}>So a participant should have a high level of skill & need to 
...
game of skill. </Text>
                  ...
                  <Text style={style.contentwithoutspace}>The Contest(s) are open only to persons above the age of 
18 years.</Text>

                  <Text style={style.content}>The Contest(s) are open only to persons currently residing in 
India.</Text>

                  <Text style={style.content}>Ludo Empire may, in accordance with the laws prevailing in 
...
of skill where participants are required to pay to enter.</Text>
                  ...
                  <Text style={style.content}>Persons who wish to participate must have a valid email 
address.</Text>

                  <Text style={style.content}>Only those Participants who have successfully registered on 
the Ludo Empire as well as registered prior to each round in 
accordance with the procedure outlined above shall be 
eligible to participate in the Contest and winnings.</Text>

                  <Text style={style.content}>Payable All prizes shall be subject to deduction of tax ("TDS") 
...
gift tax, etc. in respect of the prize.</Text>

                  <Text style={style.content}>Miscellaneous The decision of Ludo Empire with respect to 
...
be made in lieu of prizes in kind.</Text>
                  ...
                  <Text style={style.contentwithoutspace}>If it comes to the notice of Ludo Empire that any 
...
of the Contest, or contest it in any manner.</Text>

                  <Text style={style.content}>Release and Limitations of Liability</Text>

                  <Text style={style.contentwithoutspace}>Users shall access the Ludo Empire Services provided on 
...
in the Contest(s)) or as a result of acceptance of any prize.</Text>
...
to some negligent act or omission on their part, or otherwise.</Text>

                  <Text style={style.content}>Ludo Empire accepts no liability, whether jointly or severally, 
for any errors or omissions, whether on behalf of itself or 
third parties
</Text>

                  <Text style={style.content}>Users shall be solely responsible for any consequences 
...
act on the part of the Users.</Text>

                  <Text style={style.content}>Users shall indemnify, defend, and hold Ludo Empire 
...
Empire or his/her participation in any Contest(s).</Text>

                  <Text style={style.content}>In consideration of Ludo Empire allowing Users to access the 
...
or the prizes of the Contests.</Text>

                  <Text style={style.yellowheading}>Disclaimers</Text>


                  <Text style={style.contentwithoutspace}>To the extent permitted under law, neither Ludo Empire nor 
...
material.</Text>
                  ...
                  <Text style={style.content}>To the extent permitted under law, Ludo Empire shall not be 
...
any such material.</Text>

                  <Text style={style.content}>Ludo Empire shall make best endeavours to ensure that the 
Ludo Empire(s) is error-free and secure, however, neither 
Ludo Empire nor any of its partners, licensors or associates 
makes any warranty that:</Text>

                  <Text style={style.content}>The Ludo Empire(s) will meet Users' requirements,
Ludo Empire(s) will be uninterrupted, timely, secure, or 
Error free</Text>

                  <Text style={style.contentwithoutspace}>The results that may be obtained from the use of Ludo 
...
obtain through Ludo Empire(s) will meet Users expectations.</Text>

                  <Text style={style.contentwithoutspace}>In case Ludo Empire discovers any error, including any error 
...
to rectify the same.</Text>

                  <Text style={style.content}>To the extent permitted under law, neither Ludo Empire nor 
...
we have been advised of the possibility of such damages.</Text>
...
demands, claims, on any nature whatsoever.</Text>

                  <Text style={style.yellowheading}>
Taxes Payable</Text>

                  <Text style={style.contentwithoutspace}>Taxes Payable All prizes shall be subject to deduction of tax 
...
tax, gift tax, etc. in respect of the prize money.</Text>

                  <Text style={style.yellowheading}>Cancellation Policy</Text>

                  <Text style={style.contentwithoutspace}>Ludo Empire's focus is 100% customer satisfaction. In the 
...
Our Policy for the cancellation and refund will be as follows.</Text>
...
the website.</Text>
                  ...
                  <Text style={style.content}>Email: email</Text>

                  <Text style={style.content}>
Phone No: 020-67320405</Text>


                  <Text style={style.content}>Address: #15A, 4th Floor, City Vista, Tower A, Fountain Road, 
Kharadi, Pune, MH - 411014 IN.</Text>
