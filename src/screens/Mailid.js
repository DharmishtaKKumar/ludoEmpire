...
export default class Mailid extends Component {
            ...
            <Background>
                ...
                <ImageBackground
                    ...
                    source={require("../../assets/Main/yellowheading.png")}>
                        <Text style={{fontWeight:'700',fontSize:16, color:"#fff",marginLeft:"11%",marginTop:'2%', marginRight:"38%"}}>ENTER E-MAIL</Text>
                    </ImageBackground>
